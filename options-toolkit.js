        ...
        return `
          <div class="scan-card" style="cursor:pointer;" onclick="chartFromScan(${rIdx})">
            ...
            <div class="scan-trade">
              ...
              <table style="font-size:11px;margin-top:8px;border-collapse:collapse;width:100%;border-radius:8px;background:${r.direction === 'bullish' ? 'rgba(0,217,126,.06)' : 'rgba(239,68,68,.06)'};border:1px solid ${r.direction === 'bullish' ? 'rgba(0,217,126,.2)' : 'rgba(239,68,68,.2)'};">
