...
<div style="max-width:600px;margin:0 auto;padding:20px">
  ...
  <div style="text-align:center;padding:20px 0;font-size:11px;color:${BRAND.textMuted}">
    ...
    <p style="margin:8px 0 0"><a href="https://stratfordtradingacademy.com/dashboard.html" style="color:${BRAND.accent};text-decoration:none">Open Dashboard</a> &bull; <a href="https://stratfordtradingacademy.com/dashboard.html#settings" style="color:${BRAND.textMuted};text-decoration:none">Manage Notifications</a></p>
  </div>
</div>
</body></html>`;
}
  ...
  try {
    if (useResend && resendClient) {
      await resendClient.emails.send({
        from: 'Stratford Academy <noreply@stratfordtradingacademy.com>',
        to: to,
        subject: subject,
        html: html
      });
  ...
  const html = emailWrapper(subject, `
    ...
    <div style="padding:0 28px 28px">
      ...
      <div style="text-align:center;margin-top:24px">
        <a href="https://stratfordtradingacademy.com/dashboard.html" style="display:inline-block;background:${BRAND.accent};color:#000;font-weight:700;text-decoration:none;padding:14px 40px;border-radius:8px;font-size:14px">Open Your Dashboard</a>
      </div>
...
function sendSubscriptionEmail(email, name, plan) {
  ...
  const html = emailWrapper(subject, `
    ...
    <div style="padding:0 28px 28px">
      ...
      <div style="text-align:center;margin-top:24px">
        <a href="https://stratfordtradingacademy.com/dashboard.html" style="display:inline-block;background:${planColor};color:#000;font-weight:700;text-decoration:none;padding:14px 40px;border-radius:8px;font-size:14px">Go to Dashboard</a>
      </div>
    </div>
  `);
  return sendEmail(email, subject, html);
...
function sendAffiliateCommissionEmail(email, name, commission) {
  ...
  const html = emailWrapper(subject, `
    ...
    <div style="padding:0 28px 28px">
      ...
      <div style="text-align:center;margin-top:16px">
        <a href="https://stratfordtradingacademy.com/dashboard.html" style="display:inline-block;background:${BRAND.green};color:#000;font-weight:700;text-decoration:none;padding:12px 36px;border-radius:8px;font-size:13px">View Affiliate Dashboard</a>
      </div>
    </div>
  `);
  return sendEmail(email, subject, html);
  ...
  const html = emailWrapper(subject, `
    ...
    <div style="padding:0 28px 28px">
      ...
      <div style="text-align:center;margin-top:20px">
        <a href="https://stratfordtradingacademy.com/dashboard.html" style="display:inline-block;background:${BRAND.accent};color:#000;font-weight:700;text-decoration:none;padding:12px 36px;border-radius:8px;font-size:13px">View Full Report</a>
      </div>
    </div>
  `);
  return sendEmail(email, subject, html);
  ...
  const html = emailWrapper(subject, `
    ...
    <div style="padding:0 28px 28px">
      ...
      <div style="text-align:center">
        <a href="https://stratfordtradingacademy.com/dashboard.html" style="display:inline-block;background:${BRAND.accent};color:#000;font-weight:700;text-decoration:none;padding:14px 40px;border-radius:8px;font-size:14px">${config.cta}</a>
      </div>
    </div>
  `);
  return sendEmail(email, subject, html);
...
function sendCustomEmail(email, name, subject, bodyText) {
  ...
  const html = emailWrapper(subject, `
    ...
    <div style="padding:0 28px 28px">
      ...
      <div style="text-align:center;margin-top:24px">
        <a href="https://stratfordtradingacademy.com/dashboard.html" style="display:inline-block;background:${BRAND.accent};color:#000;font-weight:700;text-decoration:none;padding:14px 40px;border-radius:8px;font-size:14px">Open Dashboard</a>
      </div>
    </div>
  `);
  return sendEmail(email, subject, html);
